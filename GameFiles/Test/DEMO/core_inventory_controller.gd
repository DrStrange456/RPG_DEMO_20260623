...
@onready var core_inventory_controller: GridContainer = $"../../../../INV_AND_STRG/StorageInventoryCore_Demo/Panel/StorageCoreInventoryController"
...
func move_item_to_storage(ctx):
	...
	# FIXME: InvCore pointing to actual inventory.  should be storage dictionary
	# Could instantiate standalone storage script 
