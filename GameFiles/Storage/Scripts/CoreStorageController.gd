...
# ==============================================================================
# Storage_CoreStorageController.gd
# ==============================================================================
#
# Handles transferring items from the storage container to the inventory.
#
# LEFT CLICK
...
# Tracks the item currently being held.
...
func transfer_single_storage_item_to_container(
	...
	for destination_slot in container:
		...
		# Update inventory data.
		# Kept as InvCore.DATA to preserve existing functionality.
